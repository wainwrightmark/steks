...
pub const LEVEL_TITLE_MAX_CHARS: usize = "Tri Hard II: Tri harder".len();
pub const LEVEL_TEXT_MAX_CHARS: usize = "Use the black outlines to guide you".len();
pub const END_TEXT_MAX_CHARS: usize = "That was one in a million!".len();